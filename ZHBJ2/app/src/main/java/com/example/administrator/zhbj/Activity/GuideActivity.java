...
public class GuideActivity extends Activity {
    ...
    private CirclePageIndicator inccle_indicator;
    ...
    private void initview() {
        ...
        inccle_indicator = (CirclePageIndicator) findViewById(R.id.circle_indicastor);
        ...
        //[☆]给指示器设置viewpager
        inccle_indicator.setViewPager(viewPager);
...
//                }
        ...
        btn_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                CacheUtils.saveString(getApplicationContext(),"isFistshow","false");
            }
        });
    }
